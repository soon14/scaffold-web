...
function CRUD(options) {
  ...
  const data = {
    ...
    status: {
      ...
      // 标题
      get title() {
        return this.add > CRUD.STATUS.NORMAL ? String(i18n.t('crud.js.state.add')) + `${crud.title}` : this.edit > CRUD.STATUS.NORMAL ? String(i18n.t('crud.js.state.edit')) + `${crud.title}` : crud.title
      }
    },
    msg: {
      submit: String(i18n.t('crud.js.submit')),
      add: String(i18n.t('crud.js.add')),
      edit: String(i18n.t('crud.js.edit')),
      del: String(i18n.t('crud.js.del'))
    },
    page: {
      // 页码
      page: 0,
...
/**
 * 分页
 * @returns {{created(): void, beforeDestroy(): void, inject: {crud: {from: string}, page: {from: string}}}}
 */
function pagination() {
  return {
    inject: {
 ...
 * 表单
 * @param defaultForm
 * @returns {{created(): void, beforeDestroy(): void, inject: {crud: {from: string}, form: {from: string}}}}
 */
 ...
 * crud
 * @param options
 * @returns {{created(): void, beforeDestroy(): void, inject: {crud: {from: string}}}}
 */
function crud(options = {}) {
  const defaultOptions = {
    type: undefined
